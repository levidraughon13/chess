...
public class WebSocketHandler implements WsConnectHandler, WsMessageHandler, WsCloseHandler {
    ...
    private void connect(String authToken, Integer id, String color, Session session) throws IOException {
        try {
            ...
            color = getColor(id, color, visitorName);
    ...
    @NotNull
    private String getColor(Integer id, String color, String visitorName) throws SQLDataAccessException, BadRequestException {
        if (color == null) {
            GameData data;
    ...
    private void makeMove(String authToken, Integer gameID, ChessMove move, String color, Session session) throws IOException {
        try {
            ...
            color = getColor(gameID, color, visitorName);
